; ModuleID = '/work/zhang/common/tools/rocket/rocket-chip/gcd-rocket-vivado-hls/sub3/solution/.autopilot/db/a.o.2.bc'
target datalayout = "e-p:64:64:64-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-v64:64:64-v128:128:128-a0:0:64-s0:64:64-f80:128:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

@sub3_str = internal unnamed_addr constant [5 x i8] c"sub3\00"
...
define void @sub3(i160* %io_cmd_V, i74* %io_resp_V) {
  call void (...)* @_ssdm_op_SpecBitsMap(i74* %io_resp_V), !map !7
  call void (...)* @_ssdm_op_SpecBitsMap(i160* %io_cmd_V), !map !29
  call void (...)* @_ssdm_op_SpecTopModule([5 x i8]* @sub3_str) nounwind
  ...
  %tmp_2 = call i63 @_ssdm_op_PartSelect.i63.i160.i32.i32(i160 %tmp1, i32 96, i32 158)
  %tmp = call i64 @_ssdm_op_BitConcatenate.i64.i63.i1(i63 %tmp_2, i1 false)
  %a_V_2 = add i64 %tmp, %a_V
...
define weak i63 @_ssdm_op_PartSelect.i63.i160.i32.i32(i160, i32, i32) nounwind readnone {
entry:
  %empty = call i160 @llvm.part.select.i160(i160 %0, i32 %1, i32 %2)
  %empty_5 = trunc i160 %empty to i63
  ret i63 %empty_5
}
...
entry:
  %empty = call i160 @llvm.part.select.i160(i160 %0, i32 %1, i32 %2)
  %empty_6 = trunc i160 %empty to i5
  ret i5 %empty_6
}
...
entry:
  ...
  %empty_7 = zext i5 %2 to i10
  %empty_8 = shl i10 %empty, 5
  %empty_9 = or i10 %empty_8, %empty_7
  %empty_10 = zext i64 %0 to i74
  %empty_11 = zext i10 %empty_9 to i74
  %empty_12 = shl i74 %empty_10, 10
  %empty_13 = or i74 %empty_12, %empty_11
  ret i74 %empty_13
}
...
entry:
  ...
  %empty_14 = zext i1 %1 to i64
  %empty_15 = shl i64 %empty, 1
