...
architecture behav of sub10 is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "sub10,hls_ip_2015_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-2,HLS_INPUT_CLOCK=5.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=4.200000,HLS_SYN_LAT=0,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=2,HLS_SYN_LUT=66}";
    ...
    signal a_V_fu_69_p4 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_fu_89_p2 : STD_LOGIC_VECTOR (63 downto 0);
    signal b_V_fu_79_p4 : STD_LOGIC_VECTOR (63 downto 0);
    signal a_V_2_fu_95_p2 : STD_LOGIC_VECTOR (63 downto 0);
    signal tmp_rd_V_fu_59_p4 : STD_LOGIC_VECTOR (4 downto 0);
...
begin
    ...
    a_V_2_fu_95_p2 <= std_logic_vector(unsigned(tmp_fu_89_p2) - unsigned(b_V_fu_79_p4));
    a_V_fu_69_p4 <= io_cmd_V(95 downto 32);
    ...
    b_V_fu_79_p4 <= io_cmd_V(159 downto 96);
    ...
    io_resp_V <= ((a_V_2_fu_95_p2 & tmp_rd_V_fu_59_p4) & ap_const_lv5_0);
    ...
    tmp_fu_89_p2 <= std_logic_vector(unsigned(a_V_fu_69_p4) + unsigned(ap_const_lv64_A));
    tmp_rd_V_fu_59_p4 <= io_cmd_V(24 downto 20);
end behav;
