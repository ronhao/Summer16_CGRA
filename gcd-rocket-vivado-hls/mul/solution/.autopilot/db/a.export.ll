; ModuleID = '/work/zhang/common/tools/rocket/rocket-chip/gcd-rocket-vivado-hls/mul/solution/.autopilot/db/a.o.2.bc'
...
define void @mul(i160* %io_cmd_V, i74* %io_resp_V) {
